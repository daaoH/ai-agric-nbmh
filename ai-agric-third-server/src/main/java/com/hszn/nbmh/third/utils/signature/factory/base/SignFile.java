package com.hszn.nbmh.third.utils.signature.factory.base;


import com.hszn.nbmh.third.utils.signature.bean.*;
import com.hszn.nbmh.third.utils.signature.factory.antfinsign.CheckAntfinNotary;
import com.hszn.nbmh.third.utils.signature.factory.antfinsign.QrySignAntPushInfo;
import com.hszn.nbmh.third.utils.signature.factory.other.SearchWordsPosition;
import com.hszn.nbmh.third.utils.signature.factory.signfile.CreateFlowOneStep;
import com.hszn.nbmh.third.utils.signature.factory.signfile.attachments.CreateAttachments;
import com.hszn.nbmh.third.utils.signature.factory.signfile.attachments.DeleteAttachments;
import com.hszn.nbmh.third.utils.signature.factory.signfile.attachments.QryAttachments;
import com.hszn.nbmh.third.utils.signature.factory.signfile.datasign.DataSign;
import com.hszn.nbmh.third.utils.signature.factory.signfile.datasign.DataVerify;
import com.hszn.nbmh.third.utils.signature.factory.signfile.documents.CreateDocuments;
import com.hszn.nbmh.third.utils.signature.factory.signfile.documents.DeleteDocuments;
import com.hszn.nbmh.third.utils.signature.factory.signfile.documents.DownDocuments;
import com.hszn.nbmh.third.utils.signature.factory.signfile.pdfverify.PdfVerify;
import com.hszn.nbmh.third.utils.signature.factory.signfile.signers.GetFileSignUrl;
import com.hszn.nbmh.third.utils.signature.factory.signfile.signers.QrySigners;
import com.hszn.nbmh.third.utils.signature.factory.signfile.signers.RushSign;
import com.hszn.nbmh.third.utils.signature.factory.signfile.signfields.*;
import com.hszn.nbmh.third.utils.signature.factory.signfile.signflows.*;
...
public class SignFile {
     ...
     * @return
     */
    public static QrySignField qrySignFields(String flowId){
        return new QrySignField(flowId);
    }
