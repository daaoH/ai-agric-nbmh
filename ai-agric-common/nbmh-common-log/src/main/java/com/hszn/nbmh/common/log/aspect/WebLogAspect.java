package com.hszn.nbmh.common.log.aspect;
...
import com.hszn.nbmh.common.core.utils.IPUtils;
import com.hszn.nbmh.common.log.config.IgnoreWebLogConfigs;
...
public class WebLogAspect {
    ...
    private final List<String> headers= Arrays.asList("token","version","tenantId");
     ...
     */
    @Pointcut("execution(public * com.hszn.nbmh..*.controller..*.*(..))")
    public void webLog() {
    }
