...
public class Encryption {
    ...
    private static Base64.Encoder encodeBase64 = Base64.getEncoder();
    ...
    public static String doContentMD5(String str) throws DefineException {
        ...
        try {
            ...
            contentMD5 = new String(encodeBase64.encode(md5Bytes), StandardCharsets.UTF_8);
    ...
    public static String doSignatureBase64(String message, String secret) throws DefineException {
        ...
        try {
            ...
            digestBase64 = new String(encodeBase64.encode(digestBytes), StandardCharsets.UTF_8);
        } catch (NoSuchAlgorithmException e) {
            DefineException ex = new DefineException("不支持此算法", e);
            ex.initCause(e);
            throw ex;
