...
import com.hszn.nbmh.third.utils.signature.enums.HeaderConstant;
...
public class HttpHelper<T> {
	...
	public static Map doCommHttp(RequestType reqType, String url, String paramStr) throws DefineException {
		...
		//整体做sha256签名
		String reqSignature = Encryption.doSignatureBase64(message, Factory.getAppSecret());
	...
	private static Map<String, String> buildCommHeader(String contentMD5,String reqSignature) {
		...
		header.put("X-Tsign-Open-App-Id", Factory.getAppId());
