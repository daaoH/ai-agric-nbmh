...
@SpringBootApplication(scanBasePackages = {"com.hszn.nbmh", "com.hszn.nbmh.order", "com.hszn.nbmh.common"})
public class AiAgricOrderApplication {

    public static void main(String[] args) {
        SpringApplication.run(AiAgricOrderApplication.class, args);
    }
