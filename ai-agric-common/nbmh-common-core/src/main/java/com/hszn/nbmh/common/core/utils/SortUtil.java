...
import com.hszn.nbmh.common.core.constant.SortConstant;
...
public abstract class SortUtil {
    ...
    public static void handlePageSort(QueryRequest request, Page<?> page, String defaultSort, String defaultOrder, boolean camelToUnderscore) {
        ...
        if (camelToUnderscore) {
            sortField=HumpUtil.camelToUnderscore(sortField);
            defaultSort=HumpUtil.camelToUnderscore(defaultSort);
        }
        if (StringUtils.isNotBlank(request.getField())
            ...
            if (StringUtils.equals(request.getOrder(), SortConstant.ORDER_DESC)) {
            ...
            if (StringUtils.isNotBlank(defaultSort)) {
                if (StringUtils.equals(defaultOrder, SortConstant.ORDER_DESC)) {
