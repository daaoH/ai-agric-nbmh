...
public class Signfield {
    ...
    public void setAssignedSeal(boolean assignedSeal) {
    ...
    public String getExecuteFailedReason() {
        return executeFailedReason;
    }

    public void setExecuteFailedReason(String executeFailedReason) {
    ...
    public void setSealFileKey(String sealFileKey) {
