...
public class NbmhTradeReportController {
    ...
    @PostMapping("/add")
    @Inner(false)
    public Result add(@RequestBody @Validated({NbmhTradeReport.Save.class}) NbmhTradeReport nbmhTradeReport) {
    ...
    @PostMapping("/{id}")
    @Inner(false)
    public Result<NbmhTradeReport> getById(@PathVariable(value = "id") @NotNull Long id) {
    ...
    @PutMapping
    @Inner(false)
    public Result update(@RequestBody @Validated({NbmhTradeReport.Update.class}) NbmhTradeReport nbmhTradeReport) {
